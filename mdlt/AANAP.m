...
in_name{1} = 'images\73_A.JPG';
in_name{2} = 'images\73_B.JPG';
...
if fast_stitch
    ...
    AAPAP = imageblending(warped_img1,warped_img2);
    imshow(AAPAP);
    title('Adaptive As-Natural-As-Possible Image Stitching');
    imwrite(AAPAP,'AAPAP.jpg');
else
    ...
    AAPAP = image_blending_linear(warped_img1,warped_img2);
    imshow(AAPAP);
    title('Adaptive As-Natural-As-Possible Image Stitching');
    imwrite(AAPAP,'AAPAP.jpg');
end
